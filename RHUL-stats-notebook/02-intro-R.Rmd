...
So, based on this data, our estimate of the Hubble constant is `r round(hub.m$coefficients, digits=2)` with a standard error of `r round(summary(hub.m)$coefficients[2],digits=2)`.
